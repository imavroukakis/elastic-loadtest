...
object SearchProtocol {
  ...
  val searchProtocol: ProtocolKey[SearchProtocol, SearchComponents] =
    new ProtocolKey[SearchProtocol, SearchComponents] {

      override def protocolClass: Class[protocol.Protocol] =
        classOf[SearchProtocol].asInstanceOf[Class[protocol.Protocol]]
